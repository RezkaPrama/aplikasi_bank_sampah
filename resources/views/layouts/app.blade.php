...
<head>
    ...
    <title>{{ $title ?? config('app.name') }} - Bank Sampah</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="img-logo text-center mt-1">
            ...
            <li class="nav-item {{ Request::is('admin/jenis-sampah*') ? ' active' :  '' }}">
                <a class="nav-link" href="{{ route('admin.jenis-sampah.index') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; 2023 Bank Sampah - Trasindo Data Perkasa </span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
